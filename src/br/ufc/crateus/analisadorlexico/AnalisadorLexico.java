package br.ufc.crateus.analisadorlexico;
...
import br.ufc.crateus.analisadorsintatico.AnalisadorSintatico;
...
//
	...
	public void SCANNER(String arquivo) throws IOException, NovaException {
		...
		sint = new AnalisadorSintatico();

		sint.PARSER(tokenFila, arquivo); // chama o SINTÁTICO
	}
	public void print() {
		Iterator<Token> l = tokenFila.iterator();
		while(l.hasNext()) {
			System.out.println(l.next().getId());
		}
	}
